 ...
 * 
 * Dependencies are declared in the script using formats like this:
 * <code>
 ...
 * </code>
 * 
 * Also, additional source files can be added using:
 * <code>
...
public class Execute implements ScriptReader
{
    ...
    public static void main(String[] args) throws IOException
    {
    	if ( args.length > 0 )
    	{
    		...
    		println("Usage: java -jar patrodyne-scripting-javabang-X.X.X.jar <filename> [args]");
    }

    
	/** 
	 * Load a Java source script into a string, resolve dependencies 
